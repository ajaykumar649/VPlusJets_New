...
mu2Pars = {
    ...
    180: ( "mva2j180mu", 0.750, 165.0, 245.0, 10,
           {'diboson': (22, 11),'top':(13, 8),'WpJ':(10, 8),
            'ggH':(13, 5),'qqH':(13, 5)} ),
    ...
    250: ( "mva2j250mu", 0.800, 200.0, 400.0, 10,
           {'diboson': (22, 11), 'top': (5, 10), 'WpJ': (10, 8), 
            'ggH': (13, 5), 'qqH': (7, 5)} ),
    300: ( "mva2j300mu", 0.800, 240.0, 400.0, 8,
           {'diboson': (22, 11), 'top': (5, 12), 'WpJ': (10, 0), 
            'ggH': (13, 5), 'qqH': (7, 5)} ),
    350: ( "mva2j350mu", 0.600, 250., 475., 9,
           {'diboson': (22, 11),'top':(13, 11),'WpJ':(10, 37, None, 2),
            'ggH':(13, 5),'qqH':(7, 5)} ),
    400: ( "mva2j400mu", 0.800, 300.0, 600, 10,
           {'diboson':(31, 11),'top':(13, 12),'WpJ':(10, 0),
            'ggH':(13, 5),'qqH':(7, 5)} ),
...
el2Pars = {
    ...
    350: ( "mva2j350el", 0.800, 250., 475., 9,
           {'diboson': (22, 11),'top':(5, 11),'WpJ':(10, 0),
            'ggH':(13, 5),'qqH':(7, 5)} ),
...
def theConfig(Nj, mH, isElectron = False, initFile = [], includeSignal = True,
    ...
    if (len(modePars[mH][5]['WpJ']) > 2):
        pars.WpJAuxModels = [ modePars[mH][5]['WpJ'][2] ]
